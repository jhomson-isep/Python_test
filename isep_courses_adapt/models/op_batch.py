...
class OpBatch(models.Model):
    ...
    hp_total = fields.Float(string="Practical Hours Total", related='course_id.hp_total')
    hi_total = fields.Float(string="Independent Hours Total", related='course_id.hi_total')
    ht_total = fields.Float(string="Theoretical Hours Total", related='course_id.ht_total')
    hours_total = fields.Float(string="Hours Total", related='course_id.hours_total')
    credits_hp = fields.Float(string="Practical Hours Credits", related='course_id.credits_hp')
    credits_hi = fields.Float(string="Independent Hours Credits", related='course_id.credits_hi')
    credits_ht = fields.Float(string="Theoretical Hours Credits", related='course_id.credits_ht')
