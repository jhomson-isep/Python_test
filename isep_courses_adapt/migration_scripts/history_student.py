...
for history in historys:
    try: 
        if history.Observaciones != '' and history.Fecha is not None and history.Usuario != '':
            body = """<p>%s - %s</p>
             <p>%s</p>""" % (str(history.Fecha), str(history.Usuario), str(history.Observaciones))
