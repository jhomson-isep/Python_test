...
class MailMail(models.Model):
    ...
    @api.multi
    def send_api(self, auto_commit=False, raise_exception=False):
        ...
        for server_id, batch_ids in self._split_by_server():
            ...
            try:
                ...
                self.browse(batch_ids)._send_api(
    ...
    @api.multi
    def _send_api(self, auto_commit=False, raise_exception=False, smtp_session=None):
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                mail.write({'state': 'sent', 'message_id': False, 'failure_reason': False})
