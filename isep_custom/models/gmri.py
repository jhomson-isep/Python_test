...
class WebService:
    ...
    def InsertarLineasAsciiError(self):
        ...
        sql = "http://ws2.aplicacion.grupoisep.com/odoo.php?"
        ...
        sql += "in_FechaPrimerRecibo=" + UTF8(str.replace(str(self.FechaPrimerRecibo), "-", ""))+"&"
        ...
        sql += "in_Pack=0"
        _logger.info("ENVIANDO A LA APLICACION "+str(self.CRMIDPedido))
        
        _logger.info(sql)
        #url = urllib.quote(sql.encode('utf8'), ':/')
        #_logger.info(url)
        f = urllib.urlopen(sql)
        _logger.info(f.read())
    ...
    def InsertarLineas(self):
        ...
        sql = "http://ws2.aplicacion.grupoisep.com/odoo.php?"
        sql += "in_CRMUsuario=" + (str(self.CRMUsuario))+"&"
        sql += "in_CRMIDPedido=" + (str(self.CRMIDPedido))+"&"
        sql += "in_TipoDocID=" + (str(self.TipoDocID))+"&"
        sql += "in_DocID=" + (self.NIF)+"&"
        sql += "in_Apellidos=" + (self.Apellidos)+"&"
        sql += "in_Nombres=" + (self.Nombres)+"&"
        sql += "in_Sexo=" + (self.Sexo)+"&"
        sql += "in_FechaNacimiento=" + (str(self.FechaNacimiento))+"&"
        sql += "in_Profesion=" + (self.Profesion)+"&"
        sql += "in_Estudios=" + (self.Estudios)+"&"
        sql += "in_CentroEstudios=" + (self.CentroEstudios)+"&"
        sql += "in_AnyFinalizacionEstudios=" + (str(self.AnyFinalizacionEstudios))+"&"
        sql += "in_Telefono=" + (self.Telefono)+"&"
        sql += "in_Movil=" + (self.Movil)+"&"
        sql += "in_Fax=" + (self.Fax)+"&"
        sql += "in_EMail=" + (self.EMail)+"&"
        sql += "in_Direccion=" + (self.Direccion)+"&"
        sql += "in_Poblacion=" + (self.Poblacion)+"&"
        sql += "in_CodPostal=" + (self.CodPostal)+"&"
        sql += "in_Provincia=" + (self.Provincia)+"&"
        sql += "in_Pais=" + (self.Pais)+"&"
        sql += "in_EnvioDireccion=" + (self.Direccion)+"&"  # + (self.EnvioDireccion)+"&"
        sql += "in_EnvioPoblacion=" + (self.Poblacion)+"&"  # + (self.EnvioPoblacion)+"&"
        sql += "in_EnvioCodPostal=" + (self.CodPostal)+"&"  # + (self.EnvioCodPostal)+"&"
        sql += "in_EnvioProvincia=" + (self.Provincia)+"&"  # + (self.EnvioProvincia)+"&"
        sql += "in_EnvioPais=" + (self.Pais)+"&"  # + (self.EnvioPais)+"&"
        sql += "in_EnvioHoraEntrega=" + (self.EnvioHoraEntrega)+"&"
        sql += "in_CodIdentidad=" + (str(self.CodIdentidad))+"&"
        sql += "in_Identidad=" + (str(self.Identidad))+"&"
        sql += "in_CRMServerPath=" + (self.CRMServerPath)+"&"
        sql += "in_CodArea=" + (self.CodArea)+"&"
        sql += "in_Area=" + (self.Area)+"&"
        sql += "in_CodTipoCurso=" + (self.CodTipoCurso)+"&"
        sql += "in_TipoCurso=" + (self.TipoCurso)+"&"
        sql += "in_CodCurso=" + (self.CodCurso)+"&"
        sql += "in_Curso=" + (self.Curso)+"&"
        sql += "in_CodModalidad=" + (self.CodModalidad)+"&"
        sql += "in_Modalidad=" + (self.Modalidad)+"&"
        sql += "in_CodSede=" + (self.CodSede)+"&"
        sql += "in_Sede=" + (self.Sede)+"&"
        sql += "in_AnyAcademico=" + (str(self.AnyAcademico))+"&"
        sql += "in_HorarioPreferencia=" + (self.HorarioPreferencia)+"&"
        sql += "in_Observaciones=" + (self.Observaciones)+"&"
        sql += "in_GrupoPreferencia=" + (self.GrupoPreferencia or '')+"&"
        sql += "in_CuentaBancaria=" + (self.CuentaBancaria)+"&" 
        sql += "in_TarjetaCredito=" + (self.TarjetaCredito)+"&"
        sql += "in_CaducidadTarjetaCredito=" + (str.replace(str(self.CaducidadTarjetaCredito), "-", ""))+"&"
        sql += "in_CobroExterno=0&"
        sql += "in_PVP=0&"
        sql += "in_Descuentos=0&"
        sql += "in_Penalizacion=0&"
        ...
        sql += "in_ImporteRecibos=0&"
        sql += "in_ImporteUltimoRecibo=0&"
        sql += "in_FechaPrimerRecibo=" + (str.replace(str(self.FechaPrimerRecibo), "-", ""))+"&"
        sql += "in_PagaYSenyal=0&"
        sql += "in_DeseaFactura=0&"
        sql += "in_FacturaNIF=" + (self.PresupuestoNIF)+"&"
        sql += "in_FacturaTitular=" + (self.PresupuestoTitular)+"&"
        sql += "in_FacturaDireccion=" + (self.PresupuestoDireccion)+"&"
        sql += "in_FacturaPoblacion=" + (self.PresupuestoPoblacion)+"&"
        sql += "in_FacturaCodPostal=" + (self.PresupuestoCodPostal)+"&"
        sql += "in_FacturaProvincia=" + (self.PresupuestoProvincia)+"&"
        sql += "in_FacturaPais=" + (self.PresupuestoPais)+"&" 
        sql += "in_Pack=0"
        _logger.info("ENVIANDO A LA APLICACION "+str(self.CRMIDPedido))
        ...
        #url = urllib.quote(sql.encode('utf8'), ':/')
        #_logger.info(url)
        decoded_str = sql.decode("windows-1252")
        encoded_str = decoded_str.encode('ascii', 'ignore')
        
        f = urllib.urlopen(encoded_str)
        _logger.info(f.read())

    def InsertarLineasWS(self):
        print (" INSERTANDO LINEAS")
        self.Identidad = self._empresa.Identidad
        self.CodIdentidad = self._empresa.Nombre
